            ...
            <div className="relative min-h-screen overflow-hidden" style={{ backgroundColor: '#0D0415' }}>
                ...
                >
                    ...
                    <div className="max-w-2xl px-5 pt-6 mx-auto sm:px-4">
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            Swap, yield, lend, borrow, leverage, limit, and launch all on one, community-driven ecosystem powered by Soul Power.
                            </div>
                ...
                >
                    <ProductCard
                        ...
                        marginLeft={true}
                        title={'Enchantress Buns'}
                        description={
                            'After graduating with an MA in Economics and working in industry as a forecaster, Buns began her Web3 journey in 2020.'
                        }
                        cta={'Follow Buns'}
                    ...
                    <ProductCard
                        ...
                        title={'DeGatchi'}
                        description={
                            'After mastering the art of degen trading, DeGatchi joined Buns on her journey in Web3 in 2020 and went on to cofounding SoulSwap.'
                        }
                        cta={'Follow DeGatchi'}
